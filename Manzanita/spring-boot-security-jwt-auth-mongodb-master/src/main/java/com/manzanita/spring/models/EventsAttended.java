...
public class EventsAttended {
	...
	public EventsAttended(String eventName, String eventDescription, String eventPicture, Integer eventPrice, Date eventDate,
	...
	public EventsAttended(String id, String userId, String eventName) {
		this.id = id;
		this.eventName = eventName;
		this.userId = userId;
	}
